...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='checkpoints/htc_r50_fpn_coco-20e_20e_nuim_20201008_211415-d6c60a2c_backbone.pth')),
    img_neck=dict(
        type='FPN',
...
load_from = 'work_dirs/transfusion_nusc_voxel_L_nx/epoch_20.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
